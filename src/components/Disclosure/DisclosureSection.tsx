...
export function DisclosureSection() {
  return (
    // Use flexbox for layout: stack vertically by default, row on large screens
    <div className="flex flex-col lg:flex-row lg:space-x-12"> 
      {/* Left Side (Title) - adjust width/alignment as needed */}
      <div className="lg:w-1/4 mb-6 lg:mb-0 text-2xl font-medium text-neutral-900">
        Disclosure
      </div>

      {/* Right Side (Content) */}
      <div className="lg:w-3/4 space-y-6  text-neutral-700 text-2xl leading-relaxed">
        <p>
