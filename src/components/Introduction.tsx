...
export function Introduction() {
  return (
    <div className="md:mt-0">
      <h2 id="intro" className="text-lg text-neutral-900 border-neutral-200 mt-8 mb-4">Lindy</h2>

      <p className="text-base leading-relaxed mb-6 text-neutral-700">
      Lindy is heuristic stating that the longer something—an idea, book, or technology—has existed, the longer it is likely to continue existing. In this sense, longevity becomes a signal of robustness, wisdom, and enduring value.
      </p>
