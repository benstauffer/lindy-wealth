  ...
  return (
    <section id="process" className="w-full relative">
      ...
      <div className="flex items-center justify-between">
        ...
        <a 
          className="group inline-flex items-center px-4 py-2 text-[16px] shadow-inner text-neutral-600 hover:text-neutral-900 bg-neutral-100 border border-neutral-300 hover:bg-neutral-300 hover:border-neutral-400 rounded-lg transition-colors duration-200"
          href="#help"
        >
          Book a call
