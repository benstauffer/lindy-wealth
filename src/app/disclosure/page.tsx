        ...
        <div className="w-full px-6">
          <div className="max-w-lg mx-auto">
            ...
            <div className="space-y-6">
              ...
              <p className="text-base text-white/80 leading-relaxed">
                For more information about Lindy Wealth, please refer to our <a href="https://adviserinfo.sec.gov/firm/summary/335277" target="_blank" rel="noopener noreferrer" className="underline hover:text-white/60">Form ADV filed with the SEC</a>.
              </p>
            </div>
          </div>
          </div>
