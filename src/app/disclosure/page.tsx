      ...
      <div className="flex-1 pt-32 pb-16">
        <div className="max-w-xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-base text-black/80 leading-relaxed">
                For more information about Lindy Wealth, please refer to our <a href="https://adviserinfo.sec.gov/firm/summary/335277" target="_blank" rel="noopener noreferrer" className="underline hover:text-black/60">Form ADV filed with the SEC</a>.
              </p>
            </div>
          </div>
        </div>
